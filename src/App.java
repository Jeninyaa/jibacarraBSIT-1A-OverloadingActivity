public class App {
     ...
     */
    private static int greaterValue (int numberone, int numbertwo){
    ...
    private static double greaterValue(double numberone, double numbertwo){
        if (numberone <numbertwo){
            return numbertwo;
        }else{
            return numberone;
    ...
    public static void main(String[] args) throws Exception {
         ...
         */
        System.out.println("The sum of 80 and 355 is " + addSum(80, 355));
        System.out.println("The sum of 80, 355, 620 is " + addSum(80, 355, 620));
        /**
